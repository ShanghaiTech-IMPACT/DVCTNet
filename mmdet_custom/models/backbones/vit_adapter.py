...
"""Vision Transformer Adapter for Dense Predictions (ViT-Adapter) in PyTorch.

A PyTorch implementation of ViT-Adapter as described in:

'Vision Transformer Adapter for Dense Predictions'
    - https://arxiv.org/abs/2205.08534

The official implementation is available at https://github.com/czczup/ViT-Adapter

Acknowledgments:
* Thanks to the authors for releasing the official code.
* This implementation builds on top of their official repository.

Adapted and modified by Tao Luo, 2025.
"""
